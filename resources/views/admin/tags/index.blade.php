        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h4>Teglar</h4>
              <a href="{{ route('tags.create') }}" class="btn btn-primary" style="position:absolute; right:50;">Create</a>
            </div>
                      ...
                      <tr>
                        ...
                        <td>
                            <form action="{{ route('tags.destroy', $item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                            <a href="{{ route('tags.show', $item->id) }}" class="btn btn-info"><ion-icon class="fas fa-info-circle"></ion-icon></a>
                            <a href="{{ route('tags.edit', $item->id) }}" class="btn btn-primary"><ion-icon class="far fa-edit"></ion-icon></a>
